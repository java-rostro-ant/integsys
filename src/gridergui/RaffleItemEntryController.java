...
import org.rmj.fund.manager.parameters.PanaloItem;
 ...
 * @author User
 */
public class RaffleItemEntryController implements Initializable , ScreenInterface{
    private GRider oApp;
    private PanaloItem oTrans;
    ...
    private TextField txtField01,txtField02,txtField03
            ,txtField04,txtField05,txtSeeks99;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        oTrans = new PanaloItem(oApp, oApp.getBranchCode(), false);
...
//            txtSeeks99.setText((String) oTrans.getMaster(2));
                txtField01.setText((String) oTrans.getMaster(1));
                txtField02.setText((String) oTrans.getMaster(2));
                txtField03.setText((String) oTrans.getMaster(4));
                txtField04.setText((String) oTrans.getMaster(5));
                txtField05.setText((String) oTrans.getMaster(7));
            ...
            case F3:
                ...
                case 99: /*Search*/
                    if (oTrans.SearchRecord(txtSeeks99.getText(), false)){
                        ...
                        ShowMessageFX.Warning(getStage(), oTrans.getMessage(),"Warning", null);
                     break;
                case 03: /*Search panalo*/
                    if (oTrans.searchPanalo(txtField03.getText(), false)){
                        loadRecord();
                        pnEditMode = EditMode.READY;
                    } else 
                        ShowMessageFX.Warning(getStage(), oTrans.getMessage(),"Warning", null);
                ...
                case 04: /*Search barcode*/
                    if (!txtField04.getText().isEmpty()){
                        if (oTrans.searchSpareparts(txtField04.getText(), true)){
                        } else {
                            ShowMessageFX.Warning(getStage(), oTrans.getMessage(),"Warning", null);
                        }
                    }else{
                        ShowMessageFX.Warning(getStage(), "Barrcode must not empty!!!","Warning", null);
                    }
                    
                     break;    
                case 05: /*Search partsname*/
                   if (!txtField05.getText().isEmpty()){
                        if (oTrans.searchSpareparts(txtField05.getText(), false)){
                        } else {
                            ShowMessageFX.Warning(getStage(), oTrans.getMessage(),"Warning", null);
                        }
                    }else{
                        ShowMessageFX.Warning(getStage(), "Parts name must not empty!!!","Warning", null);
                    }

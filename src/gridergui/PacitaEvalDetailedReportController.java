...
import org.rmj.grewards.report.EvaluationDetailed;
 ...
 * @author User
 */
public class PacitaEvalDetailedReportController implements Initializable, ScreenInterface{
    private final String pxeModuleName = "Pacita's Detailed Report";
    final static int interval = 100;
    private Timeline timeline;
    private Integer timeSeconds = 3;
    private GRider oApp;
    
    private EvaluationDetailed oTrans;
...
//    private JasperPreview jasperPreview;
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        oTrans  = new EvaluationDetailed(oApp, oApp.getBranchCode(), false);
        ...
        try{
                 params.put("sReportNm", pxeModuleName);
                    ...
                    master_data.add(new TableModel(
                        ...
                        oTrans.getRecord(x, "sDeptName").toString(),
                        oTrans.getRecord(x, "dTransact").toString(),
                            CommonUtils.NumberFormat((BigDecimal) oTrans.getRecord(x, "nRatingxx"),"##0.00"),
                        String.valueOf(x),""
                    ));

                        }
                    }
                    String sourceFileName = "D://GGC_Java_Systems/reports/PacitaEvalDetailed.jasper";
